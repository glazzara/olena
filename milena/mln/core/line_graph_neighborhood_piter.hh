...
namespace mln
{
  ...
  class line_graph_neighborhood_fwd_piter :
    public internal::line_graph_vicinity_piter_< P, line_graph_neighborhood_fwd_piter<P, N> >
  {
  ...
  class line_graph_neighborhood_bkd_piter :
    public internal::line_graph_vicinity_piter_< P, line_graph_neighborhood_bkd_piter<P, N> >
  {
