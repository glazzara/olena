...
typedef struct {
  ...
  u_int32_t *dfils;  /* tableau donnant l'index+1 du dernier fils dans le tableau 'fils' */
  u_int32_t *fils;   /* tableau representant, avec le precedent, la relation 'fils' */  
...
/* ==================================== */
static int32_t contrib_perim(int32_t p, u_int8_t *ORI, u_int32_t *STATUS, int32_t rs, int32_t N, int32_t incr_vois)
/* ==================================== */
...
/* ==================================== */
static int32_t contrib_perimb(int32_t p, u_int8_t *ORI, u_int32_t *STATUS, int32_t rs, int32_t N, int32_t connex)
/* ==================================== */
{ /* calcule la contribution du point p au perimetre de la composante */
  int32_t q, k, nv = 0;
...
/* ==================================== */
static int32_t contrib_hbord(int32_t p, u_int8_t *ORI, u_int32_t *STATUS, int32_t rs, int32_t N, int32_t incr_vois)
/* ==================================== */
...
/* ==================================== */
static int32_t contrib_hbordb(int32_t p, u_int8_t *ORI, u_int32_t *STATUS, int32_t rs, int32_t N, int32_t connex)
/* ==================================== */
{ /* calcule la contribution du point p au hbord de la composante */
  int32_t q, k, h = 0;
...
static int32_t flood(int32_t h,                 /* niveau a inonder */
          Fah *FAH, 
          u_int32_t *STATUS,         /* etat d'un pixel - doit etre initialise a NOT_ANALYZED */
