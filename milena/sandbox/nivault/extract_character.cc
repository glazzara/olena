...
draw_bbox(I& image, box2d box)
{
  ...
  draw::line (image, p1, p2, literal::red);
  draw::line (image, p2, p4, literal::red);
  draw::line (image, p4, p3, literal::red);
  draw::line (image, p3, p1, literal::red);
}
