...
int main(int argc, char* argv[])
{
  ...
  if      (nbhs == "6_26")  conn_numbers = connectivity_numbers_3d_tbb__6_26();
  else if (nbhs == "26_6")  conn_numbers = connectivity_numbers_3d_tbb__26_6();
  else if (nbhs == "6p_18") conn_numbers = connectivity_numbers_3d_tbb__6p_18();
  else if (nbhs == "18_6p") conn_numbers = connectivity_numbers_3d_tbb__18_6p();
  else
    usage(argv[0]);
