...
namespace mln
{
  ...
  namespace clustering
  {
    ...
    template <typename T, unsigned n>
    inline
    kmean3d<T,n>::kmean3d(const t_point_img& point,
			  const unsigned     k_center,
			  ...
			  const unsigned     n_times)
    {
      ...
      _n_times           = n_times;
      _point             = point;
      _histo             =data::compute(accu::meta::stat::histo3d_rgb(),_point);
    ...
    template <typename T, unsigned n>
    inline
    void kmean3d<T,n>::set_point(t_point_img& point)
    {
      trace::entering("mln::clustering::kmean3d::set_point");

      _point = point;

      trace::exiting("mln::clustering::kmean3d::set_point");
    }

    template <typename T, unsigned n>
    inline
    void kmean3d<T,n>::set_histo(t_histo_img& histo)
    {
      trace::entering("mln::clustering::kmean3d::set_histo");

      _histo = histo;

      trace::exiting("mln::clustering::kmean3d::set_histo");
    }

    template <typename T, unsigned n>
    inline
    void kmean3d<T,n>::set_number(t_number_img& number)
    {
      trace::entering("mln::clustering::kmean3d::set_number");

      _number = number;

      trace::exiting("mln::clustering::kmean3d::set_number");
    }

    template <typename T, unsigned n>
    inline
    void kmean3d<T,n>::set_mean(t_mean_img& mean)
    {
      trace::entering("mln::clustering::kmean3d::set_mean");

      _mean = mean;

      trace::exiting("mln::clustering::kmean3d::set_mean");
    }

    template <typename T, unsigned n>
    inline
    void kmean3d<T,n>::set_variance(t_variance_img& variance)
    {
      trace::entering("mln::clustering::kmean3d::set_variance");

      _variance = variance;

      trace::exiting("mln::clustering::kmean3d::set_variance");
    }

    template <typename T, unsigned n>
    inline
    void kmean3d<T,n>::set_group(t_group_img& group)
    {
      trace::entering("mln::clustering::kmean3d::set_group");

      _group = group;

      trace::exiting("mln::clustering::kmean3d::set_group");
    }

    template <typename T, unsigned n>
    inline
    void kmean3d<T,n>::set_distance(t_distance_img& distance)
    {
      trace::entering("mln::clustering::kmean3d::set_distance");

      _distance = distance;

      trace::exiting("mln::clustering::kmean3d::set_distance");
    }

    template <typename T, unsigned n>
    inline
    typename kmean3d<T,n>::t_point_img& kmean3d<T,n>::get_point()
    {
      trace::entering("mln::clustering::kmean3d::get_point");

      trace::exiting("mln::clustering::kmean3d::get_point");
      return _point;
    }

    template <typename T, unsigned n>
    inline
    typename kmean3d<T,n>::t_histo_img& kmean3d<T,n>::get_histo()
    {
      trace::entering("mln::clustering::kmean3d::get_histo");

      trace::exiting("mln::clustering::kmean3d::get_histo");
      return _histo;
    }

    template <typename T, unsigned n>
    inline
    typename kmean3d<T,n>::t_number_img& kmean3d<T,n>::get_number()
    {
      trace::entering("mln::clustering::kmean3d::get_number");

      trace::exiting("mln::clustering::kmean3d::get_number");
      return _number;
    }

    template <typename T, unsigned n>
    inline
    typename kmean3d<T,n>::t_mean_img& kmean3d<T,n>::get_mean()
    {
      trace::entering("mln::clustering::kmean3d::get_mean");

      trace::exiting("mln::clustering::kmean3d::get_mean");
      return _mean;
    }

    template <typename T, unsigned n>
    inline
    typename kmean3d<T,n>::t_variance_img& kmean3d<T,n>::get_variance()
    {
      trace::entering("mln::clustering::kmean3d::get_variance");

      trace::exiting("mln::clustering::kmean3d::get_variance");
      return _variance;
    }

    template <typename T, unsigned n>
    inline
    typename kmean3d<T,n>::t_group_img& kmean3d<T,n>::get_group()
    {
      trace::entering("mln::clustering::kmean3d::get_group");

      trace::exiting("mln::clustering::kmean3d::get_group");
      return _group;
    }

    template <typename T, unsigned n>
    inline
    typename kmean3d<T,n>::t_distance_img& kmean3d<T,n>::get_distance()
    {
      trace::entering("mln::clustering::kmean3d::get_distance");

      trace::exiting("mln::clustering::kmean3d::get_distance");
      return _distance;
    }

    template <typename T, unsigned n>
    inline
    typename kmean3d<T,n>::t_color_dbg& kmean3d<T,n>::get_color_dbg()
    {
      trace::entering("mln::clustering::kmean3d::get_color_dbg");

      trace::exiting("mln::clustering::kmean3d::get_color_dbg");
      return _color_dbg;
    }

    template <typename T, unsigned n>
    inline
    typename kmean3d<T,n>::t_mean_dbg& kmean3d<T,n>::get_mean_dbg()
    {
      trace::entering("mln::clustering::kmean3d::get_mean_dbg");

      trace::exiting("mln::clustering::kmean3d::get_mean_dbg");
      return _mean_dbg;
    }

    template <typename T, unsigned n>
    inline
    typename kmean3d<T,n>::t_label_dbg& kmean3d<T,n>::get_label_dbg()
    {
      trace::entering("mln::clustering::kmean3d::get_label_dbg");

      trace::exiting("mln::clustering::kmean3d::get_label_dbg");
      return _label_dbg;
    }

    template <typename T, unsigned n>
    inline
    typename kmean3d<T,n>::t_mean_cnv& kmean3d<T,n>::get_mean_cnv()
    {
      trace::entering("mln::clustering::kmean3d::get_mean_cnv");

      trace::exiting("mln::clustering::kmean3d::get_mean_cnv");
      return _mean_cnv;
    }

    template <typename T, unsigned n>
    inline
    typename kmean3d<T,n>::t_variance_cnv& kmean3d<T,n>::get_variance_cnv()
    {
      trace::entering("mln::clustering::kmean3d::get_variance_cnv");

      trace::exiting("mln::clustering::kmean3d::get_variance_cnv");
      return _variance_cnv;
    }

    template <typename T, unsigned n>
    inline
    typename kmean3d<T,n>::t_mean_img& kmean3d<T,n>::to_result()
    {
      trace::entering("mln::clustering::kmean3d::to_result");

      trace::exiting("mln::clustering::kmean3d::to_result");
      return _mean_min;
    }
    ...
    template <typename T, unsigned n>
    inline
    void kmean3d<T,n>::print_mean()
    {
      trace::entering("mln::clustering::kmean3d::print_mean");
	...
	std::cout << "]"          << std::endl;
      ...
      trace::exiting("mln::clustering::kmean3d::print_mean");
    }

    template <typename T, unsigned n>
    inline
    void kmean3d<T,n>::print_number()
    {
      trace::entering("mln::clustering::kmean3d::print_number");
	...
	std::cout << std::endl;
      ...
      trace::exiting("mln::clustering::kmean3d::print_number");
    }

    template <typename T, unsigned n>
    inline
    void kmean3d<T,n>::print_variance()
    {
      trace::entering("mln::clustering::kmean3d::print_variance");
	...
	std::cout << std::endl;
      ...
      trace::exiting("mln::clustering::kmean3d::print_variance");
    }

    template <typename T, unsigned n>
    inline
    void kmean3d<T,n>::print_histo()
    {
      trace::entering("mln::clustering::kmean3d::print_histo");
	...
	if (0 < _histo(rgb))
	{
      ...
      trace::exiting("mln::clustering::kmean3d::print_histo");
    }

    template <typename T, unsigned n>
    inline
    void kmean3d<T,n>::print_group()
    {
      trace::entering("mln::clustering::kmean3d::print_group");
	...
	if (0 < _histo(rgb))
	{
      ...
      trace::exiting("mln::clustering::kmean3d::print_group");
    }

    template <typename T, unsigned n>
    inline
    void kmean3d<T,n>::print_distance()
    {
      trace::entering("mln::clustering::kmean3d::print_distance");
	...
	for_all(rgb)
	{
      ...
      trace::exiting("mln::clustering::kmean3d::print_distance");
    }

    template <typename T, unsigned n>
    inline
    void kmean3d<T,n>::print_point()
    {
      trace::entering("mln::clustering::kmean3d::print_point");
	...
	std::cout << std::endl;
      ...
      trace::exiting("mln::clustering::kmean3d::print_point");
    }
    ...
    template <typename T, unsigned n>
    inline
    void kmean3d<T,n>::init_mean_random()
    {
      trace::entering("mln::clustering::kmean3d::init_mean_random");
	...
	_mean[l.index_()][2] = (rand() % (max_comp2-min_comp2)) + min_comp2;
      ...
      trace::exiting("mln::clustering::kmean3d::init_mean_random");
    }

    template <typename T, unsigned n>
    inline
    void kmean3d<T,n>::init_mean()
    {
      trace::entering("mln::clustering::kmean3d::init_mean");

      init_mean_random();

      trace::exiting("mln::clustering::kmean3d::init_mean");
    }
    ...
    template <typename T, unsigned n>
    inline
    void kmean3d<T,n>::update_distance()
    {
      trace::entering("mln::clustering::kmean3d::update_distance");
	...
	for_all(d)
	{
	  ...
	  */
      ...
      trace::exiting("mln::clustering::kmean3d::update_distance");
    }

    template <typename T, unsigned n>
    inline
    void kmean3d<T,n>::update_group()
    {
      trace::entering("mln::clustering::kmean3d::update_group");
	...
	//std::cout << "-----------" << std::endl;
      ...
      trace::exiting("mln::clustering::kmean3d::update_group");
    }

    template <typename T, unsigned n>
    inline
    void kmean3d<T,n>::update_mean()
    {
	...
	//std::cout << "c" << l << " = " << _mean(l) << std::endl;
      ...
      trace::exiting("mln::clustering::kmean3d::update_mean");
    }

    template <typename T, unsigned n>
    inline
    void kmean3d<T,n>::update_variance()
    {
      trace::entering("mln::clustering::kmean3d::update_variance");
	...
	//std::cout << "v(" << l << ") = " << _variance(l) << std::endl;
      ...
      trace::exiting("mln::clustering::kmean3d::update_variance");
    }
    ...
    template <typename T, unsigned n>
    inline
    void kmean3d<T,n>::build_label_dbg()
    {
      trace::entering("mln::clustering::kmean3d::build_label_dbg");
    ...
    template <typename T, unsigned n>
    inline
    void kmean3d<T,n>::build_mean_dbg()
    {
      trace::entering("mln::clustering::kmean3d::build_mean_dbg");
	...
	_mean_dbg(p).blue()  = static_cast<unsigned>(_mean[_label_dbg(p)][2]);
      ...
      trace::exiting("mln::clustering::kmean3d::build_mean_dbg");
    }


    template <typename T, unsigned n>
    inline
    void kmean3d<T,n>::build_all_dbg()
    {
    ...
    template <typename T, unsigned n>
    inline
    void kmean3d<T,n>::update_cnv()
    {
      trace::entering("mln::clustering::kmean3d::update_cnv");
	...
	_mean_cnv[l.index_()][_current_launching](point1d(_current_step))
      ...
      trace::exiting("mln::clustering::kmean3d::update_cnv");
    }

    template <typename T, unsigned n>
    inline
    void kmean3d<T,n>::finalize_cnv()
    {
      trace::entering("mln::clustering::kmean3d::finalize_cnv");
	...
	for_all(l)
	{
      ...
      trace::exiting("mln::clustering::kmean3d::finalize_cnv");
    }
    ...
    template <typename T, unsigned n>
    inline
    bool kmean3d<T,n>::is_descent_valid()
    {
      trace::entering("mln::clustering::kmean3d::is_descent_valid");

      bool result = _is_number_valid && (_current_step < _watch_dog);

      trace::exiting("mln::clustering::kmean3d::is_descent_valid");
      return result;
    }
    ...
    template <typename T, unsigned n>
    inline
    void kmean3d<T,n>::launch_one_time()
    {
      trace::entering("mln::clustering::kmean3d::launch_one_time");
	...
	++_current_step;
      ...
      trace::exiting("mln::clustering::kmean3d::launch_one_time");
    }


    template <typename T, unsigned n>
    inline
    void kmean3d<T,n>::launch_n_times()
    {
      trace::entering("mln::clustering::kmean3d::launch_n_times");
...
#endif // ! MLN_CLUSTERING_KMEAN3D_HH
