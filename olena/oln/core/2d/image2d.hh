...
namespace oln
{
  ...
  public:
    ...
    typedef typename vtypes< image2d<T> >::pixter pixter;
    typedef typename vtypes< image2d<T> >::offset offset;
    stc_using(point);
    stc_using(data);
...
# ifndef OLN_INCLUDE_ONLY
  ...
  image2d<T>::point_at_offset(typename image2d<T>::offset offset) const
  {
